...
const LeagueTable = () => {
  ...
  function splitForm(form) {
    return form.replace(/,/gi, '').split('').reverse().join(' ')
  }
      ...
      <table className="table is-striped">
        <thead>
          <tr>
            ...
            <th>Team</th>
            <th className="has-text-centered">Pld</th>
            <th className="has-text-centered">W</th>
            <th className="has-text-centered">D</th>
            <th className="has-text-centered">L</th>
            <th className="has-text-centered">GF</th>
            <th className="has-text-centered">GA</th>
            <th className="has-text-centered">GD</th>
            <th className="has-text-centered">Pts</th>
            <th className="has-text-centered">Form</th>
          </tr>
        </thead>
        <tbody>
          {table.map((team, index) => {
            return <tr key={index} className={buildClasses(team, index)}>
              <th className="has-text-centered">{team.position}</th>
              <th style={{
              ...
              <td className="has-text-centered">{team.playedGames}</td>
              <td className="has-text-centered">{team.won}</td>
              <td className="has-text-centered">{team.draw}</td>
              <td className="has-text-centered">{team.lost}</td>
              <td className="has-text-centered">{team.goalsFor}</td>
              <td className="has-text-centered">{team.goalsAgainst}</td>
              <td className="has-text-centered">{team.goalDifference}</td>
              <td className="has-text-centered">{team.points}</td>
              <td className="has-text-centered">{splitForm(team.form)}</td>
            </tr>
          })}
        </tbody>
      </table>
